function [fig] = plotPiezoStepResponse(T,varargin)
...
for r = 1:size(T,1)
    ...
    plot(posax,x(xidx),-trial.probe_position(xidx),'tag',num2str(T_row.trial));
    plot(aiax,x(xidx),trial.voltage_1(xidx),'tag',num2str(T_row.trial));
end    
