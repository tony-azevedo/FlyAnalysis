...
rejects = {'150913_F2_C1', '151002_F2_C1', '151007_F4_C1'};
clr = [0 0 1];
...
for r = 1:size(rejects,1)
    ...
    set(findobj(wrd_axes,'type','line','displayname',rejects{r,1}),'color',clr);
...
for g = 1:length(genotypes)
    ...
    for r = 1:size(pnl_hs,1)
        for c = 1:size(pnl_hs,2)
            ...
            set(ave,'ydata',nanmean(traces,1));
            % std set(ave,'ydata',mean(traces,1));
        end
    end
end
