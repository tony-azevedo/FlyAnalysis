function newfig = CurrentChirpScimFamily(h,handles,savetag)
...
for bt = blocktrials;
    ...
    line(handles.trial.exposureTimes,scimtraces,...
        'parent',pnl(1).select(),'color',[0 .6 0] + [1 0  1]*cnt/length(blocktrials),...
        'displayname',[num2str(handles.trial.params.step) ' pA']);
    cnt = cnt+1;
