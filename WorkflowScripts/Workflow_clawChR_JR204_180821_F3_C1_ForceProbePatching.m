...
trial = load('B:\Raw_Data\180821\180821_F3_C1\EpiFlash2T_Raw_180821_F3_C1_15.mat');
...
clear trials
% trials{1} = 1:91; % Forgot the red cube flashes
trials{1} = 92:98; % Blue flashes
trials{2} = 99:176; % Red cube in 
