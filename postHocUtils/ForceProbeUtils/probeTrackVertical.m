...
%% 2) Should we look at one or two locations?
% [pks,locs] = findpeaksWithCurrentModel(filtered_mu);
% function [pks,locs] = findpeaksWithCurrentModel(ffm)

[pks,locs] = findpeaks(filtered_mu,'MinPeakWidth',1280/50,'MinPeakProminence',2); 
