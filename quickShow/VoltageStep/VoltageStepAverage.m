function h = VoltageStepAverage(h,handles,savetag,varargin)
...
if dual 
    ...
    elseif strcmp(p.Results.callingfile,'VoltageStepFamMatrix')
...
if dual && strcmp(p.Results.callingfile,'VoltageStepFamMatrix')
...
if dual
    if strcmp(p.Results.callingfile,'VoltageStepFamMatrix')
