...
[pks,locs] = findpeaks(filtered_mu,'MinPeakWidth',length(filtered_mu)/100,'MinPeakProminence',.5); %/30);
...
[pks,locs] = findpeaks(filtered_frame_mu(trough:righthash),'MinPeakWidth',length(filtered_frame_mu)/100,'MinPeakProminence',.5); %/30);
pks = pks-dark_right;
...
%     end
    ...
    [pks,locs] = findpeaks(filtered_frame_mu-dark,'MinPeakWidth',length(filtered_frame_mu)/100,'MinPeakProminence',.5); %/30);
