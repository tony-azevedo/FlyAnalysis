function h = responseWithVideo_segment(h,handles,savetag,varargin)
...
% open a movie
output_video = [init.figpath '\' filename(1:end-4) '_Combined_' num2str(round(t_win(1)*1000)) '_' num2str(round(t_win(2)*1000)) '.avi'];
