...
t_i = 0; %10*1/vid.FrameRate + trial.params.preDurInSec;
t_f = 4/vid.FrameRate; %min([trial.params.stimDurInSec-10*1/vid.FrameRate,1]);
...
%         waitbar((tr_num-trialnumlist(1)+1)/length(trialnumlist),br);
        ...
        vid2 = VideoReader(trial.imageFile2); %#ok<TNMLP>
        vid2.CurrentTime = t_i;       
