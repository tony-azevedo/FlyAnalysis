function quickShow_EpiFlash(plotcanvas,obj,savetag)
...
ax2 = panl(2).select();
line(x,EpiFlashStim(obj.trial.params),'parent',ax2,'color',[0 0 1],'tag',savetag);
ylabel(ax2,'EpiFlash (V)'); %xlim([0 max(t)]);
