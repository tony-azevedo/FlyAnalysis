%% Record_Figure4 - PiezoSteps and phases
close all
...
set(figure4,'color',[1 1 1],'position',[1 .4 getpref('FigureSizes','NeuronOneAndHalfColumn'),10])
pnl = panel(figure4);
...
savedir = '/Users/tony/Dropbox/AzevedoWilson_B1_MS/Figure4/';
savePDF(figure4,savedir,[],'Figure4ad')

%% polar plots of sine coefficients

% figure4 = figure;
% figure4.Units = 'inches';
% set(figure4,'color',[1 1 1],'position',[1 0 getpref('FigureSizes','NeuronOneAndHalfColumn'),10])
% pnl = panel(figure4);
% 
