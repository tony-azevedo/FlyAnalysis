...
% Tibia length
% Measure fulcrum to max distance
...
% Measurement #2
% 1	0.000	934	934	934	137.550	63.666	1	53	0	3
% 2	0.000	480	480	480	418.152	374.922	1	72	0	3
% 3	0.000	678	678	678	447.234	468.456	1	44	0	3
x_1 = 	[137.550	63.666		53]; 
x_2 =	[418.152	374.922		72];
norm(x_1-x_2) % 419.5
x_1 = 	[137.550	63.666		53]; 
x_2 =	[447.234	468.456		44];
norm(x_1-x_2) % 509
