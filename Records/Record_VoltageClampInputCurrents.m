...
a2_cell(cnt).PiezoSineTrial_IClamp = ...
'';
a2_cell(cnt).VoltageStepTrial = ...
'C:\Users\tony\Raw_Data\151212\151212_F1_C1\VoltageStep_Raw_151212_F1_C1_1.mat';
a2_cell(cnt).VoltageCommandTrial = ...
'';
a2_cell(cnt).CurrentChirpTrial = ...
'';
end
...
%% 45D07
cnt = find(strcmp(r45D07_cells,'151216_F1_C1'));
if ~isempty(cnt)
...
cnt = find(strcmp(r45D07_cells,'151219_F1_C1'));
if ~isempty(cnt)
    r45D07_cell(cnt).PiezoSineTrial = ...
'C:\Users\tony\Raw_Data\151219\151219_F1_C1\PiezoSine_Raw_151219_F1_C1_7.mat';
r45D07_cell(cnt).PiezoStepTrial = ...
...
cnt = find(strcmp(r45D07_cells,'151219_F1_C2'));
if ~isempty(cnt)
    r45D07_cell(cnt).PiezoSineTrial = ...
...
cnt = find(strcmp(r45D07_cells,'151219_F1_C3'));
if ~isempty(cnt)
    r45D07_cell(cnt).PiezoSineTrial = ...
