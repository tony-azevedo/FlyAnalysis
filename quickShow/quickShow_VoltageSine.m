function quickShow_VoltageSine(plotcanvas,obj,savetag)
...
if length(x) > 100000
    line(downsample(x,10),downsample(current,10),'parent',ax1,'color',[1 0 0],'tag',savetag);
else
...
if length(x) > 100000
    line(downsample(x,10),downsample(voltage,10),'parent',ax2,'color',[0 0 1],'tag',savetag);
else
