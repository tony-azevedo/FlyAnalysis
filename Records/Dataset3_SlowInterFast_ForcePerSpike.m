...
%% Show different fitting strategies
Script_forcePerSpikeAndFiringRate

%% Plot twitch vs position
Script_plotTwitchVsLegAngle

%% Average twitches and emgs, calculate cv and estimate force production onset
