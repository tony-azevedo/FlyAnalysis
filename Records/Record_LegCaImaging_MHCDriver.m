%% Record - Muscle imaging preliminary analysis, for Pierre

% Good recordings to look at first.
% This is the example recording I showed in my lab meeting talk
trial = load('B:\Raw_Data\170705\170705_F1_C1\EpiFlash2T_Raw_170705_F1_C1_25.mat');

% a trial is a mat structure that has infomation about the recording and
% any analysis done on the data. Unfortunately, most of the lines that have
% a file path associated with it are hard coded.

trial.imageFile % is the path to the video taken at the same time.


% Other good examples- Clear segmentation, interesting dynamics
