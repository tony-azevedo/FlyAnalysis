...
%T{1,:} = {'170921_F1_C1', '81A07',            'fast', 'PiezoStep2T','empty',0}; % no steps
T{1,:} = {'171101_F1_C1', '81A07',            'fast', 'PiezoRamp2T','empty',0}; 
%T{3,:} = {'171102_F1_C1', '81A07',            'fast', 'PiezoStep2T','empty',[]};
T{2,:} = {'171102_F2_C1', '81A07',            'fast', 'PiezoRamp2T','empty',0}; 
T{end+1,:} = {'171103_F1_C1', '81A07',            'fast', 'PiezoRamp2T','empty',0};
T{end+1,:} = {'180308_F3_C1', '81A07',            'fast', 'PiezoRamp2T','empty',[-150 -75  0 75 150]};
...
T{end+1,:} = {'180405_F3_C1', '22A08',            'intermediate', 'PiezoRamp2T','empty',[-150 -75  0 75 150]};
T{end+1,:} = {'180807_F1_C1', '22A08',            'intermediate', 'PiezoRamp2T','empty',[-150 -75  0 75 150]};
...
ax = subplot(3,2,1); ax.NextPlot = 'add'; ax.YLim = [-30 -4];
title('Extension depolarizes neuron')
plot(t,trial.voltage_1,'k'), hold on, raster(ax,t(trial.spikes),[-7 -4]);

ax = subplot(3,2,3); ax.NextPlot = 'add'; ax.YLim = [-30 40];
plot(t,trial.current_2,'k')

ax = subplot(3,2,5); ax.NextPlot = 'add';
plot(t,trial.sgsmonitor,'b')

trial = load('E:\Data\181021\181021_F1_C1\PiezoStep2T_Raw_181021_F1_C1_171.mat');
t = makeInTime(trial.params);
ax = subplot(3,2,2); ax.NextPlot = 'add'; ax.YLim = [-30 -4];
...
ax = subplot(3,2,4); ax.NextPlot = 'add'; ax.YLim = [-30 40];
plot(t,trial.current_2,'k')
