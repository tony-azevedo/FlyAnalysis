%Implement the B1 conductance model in Voltage Clamp, without the VG
%conductances contributing to the current (They are multiplied by 0)
function out = B1DynamicalSystem_VClamp_VGBLock(V,T,varargin)
