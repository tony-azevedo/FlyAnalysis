function newfig = PiezoStimulusScimStackFamily(h,handles,savetag)
...
pnl(1).title(sprintf('%s Block %d: {%s}', [handles.trial.params.stimulusName '.' dateID '.' flynum '.' cellnum],b,sprintf('%s; ',tags{:})));
