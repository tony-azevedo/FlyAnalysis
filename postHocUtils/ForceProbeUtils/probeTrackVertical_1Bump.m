...
% This is just the upper rectangle

% l_eval = [p_;size(smooshedframe,2),p_(2)];
% 
...
% 2) Find the best guess for one bar location: peak of the mean near
...
% else
    bar_threshold_right =13/32;% 23/32
    bar_threshold_left = 13/32; %19/32
