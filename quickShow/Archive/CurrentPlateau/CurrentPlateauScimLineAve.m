function h = CurrentPlateauScimLineAve(h,handles,savetag,varargin)
...
for t = 1:length(trials)
    ...
    redtraces(:,t) = trial.scimLineTrace(:,1)/mean(trial.scimLineTrace(exp_t<=0,1)) *100 -100;
    greentraces(:,t) = trial.scimLineTrace(:,2)/mean(trial.scimLineTrace(exp_t<=0,2))*100 -100;
