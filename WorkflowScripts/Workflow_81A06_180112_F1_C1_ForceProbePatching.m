...
trial = load('B:\Raw_Data\180112\180112_F1_C1\CurrentStep2T_Raw_180112_F1_C1_19.mat');
...
trial = load('B:\Raw_Data\180112\180112_F1_C1\EpiFlash2T_Raw_180112_F1_C1_1.mat');
[~,~,~,~,~,~,trialStem,~] = extractRawIdentifiers(trial.name);
...
trial = load('B:\Raw_Data\180112\180112_F1_C1\PiezoRamp2T_Raw_180112_F1_C1_1.mat');
[~,~,~,~,~,~,trialStem,~] = extractRawIdentifiers(trial.name);
