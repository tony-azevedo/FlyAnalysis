%Implement the B1 conductance model in response to current injection,
%without the VG conductances contributing to the current (They are
%multiplied by 0) 
function out = B1DynamicalSystem_VGBlock(I,T,varargin)
