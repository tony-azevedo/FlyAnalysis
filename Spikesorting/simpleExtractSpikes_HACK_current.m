...
% elseif ~isfield(trial,'spikes')
    ...
    fs = trial.params.sampratein; %% sample rate
    t = makeInTime(trial.params);
    patch = trial.current_1-mean(trial.current_1(t<0));
    ...
    spike_waveform(t<0-trial.params.preDurInSec+0.1) = 0;
...
xlim(trial.params.sampratein*[trial.params.preDurInSec-.05 trial.params.preDurInSec+trial.params.stimDurInSec+ trial.params.postDurInSec])
