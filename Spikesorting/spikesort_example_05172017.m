...
spikes.fs = si/0.01;%% sampling rate
...
%% run spike ID
[spike_inds, spikesBelowThresh, spiketemplate, spikeDist_threshold, vars] = spike_extractor_05162017(patch_1(spikes.spike_count_range),piezo(spikes.spike_count_range), spikes, init);
