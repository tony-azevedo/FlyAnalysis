...
trial = load('B:\Raw_Data\180118\180118_F1_C1\PiezoRamp2T_Raw_180118_F1_C1_1.mat');
...
trial = load('B:\Raw_Data\180118\180118_F1_C1\EpiFlash2T_Raw_180118_F1_C1_11.mat');
[protocol,~,~,~,~,~,trialStem,~] = extractRawIdentifiers(trial.name);

clear trials
trials{1} = 1:10; % beautiful vidoes of the leg with no bar, but not analyable yet
trials{2} = 11:31; 
Nsets = length(trials);
...
trial = load('B:\Raw_Data\180118\180118_F1_C1\EpiFlash2TTrain_Raw_180118_F1_C1_5.mat');
[protocol,~,~,~,~,~,trialStem,~] = extractRawIdentifiers(trial.name);
