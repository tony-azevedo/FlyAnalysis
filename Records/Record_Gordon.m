...
%textbp(sprintf('%d Hz',freqs(f_ind)),'fontname','Arial','fontsize',12);
export_fig 'C:\Users\Anthony Azevedo\Dropbox\Gordon2014\Matlab\FrequencySelectivity.pdf'
...
%textbp(sprintf('%d Hz',freqs(f_ind)),'fontname','Arial','fontsize',12);
export_fig 'C:\Users\Anthony Azevedo\Dropbox\Gordon2014\Matlab\PopulationSelectivity.pdf'
...
%textbp(sprintf('%d Hz',freqs(f_ind)),'fontname','Arial','fontsize',12);
export_fig 'C:\Users\Anthony Azevedo\Dropbox\Gordon2014\Matlab\StepTraces.pdf'
...
%% 3rd Order Neurons: Freq Response curves and sound responses to courtship song
clear analysis_cell
cnt = 1;
analysis_cell(cnt).name = {
    '140219_F3_C4'
...
for c_ind = 1:length(analysis_cell)
    ...
    for bt = blocktrials;
        ...
        if (sum(freq == freqs) && sum(dspl == displacements))
            ...
            set(to_ax,'xlim',[-.15  .5],'ylim',[-55  -15])
...
%textbp(sprintf('%d Hz',freqs(f_ind)),'fontname','Arial','fontsize',12);
export_fig 'C:\Users\Anthony Azevedo\Dropbox\Gordon2014\Matlab\WedgeFrequencyResponses.pdf'
...
%textbp(sprintf('%d Hz',freqs(f_ind)),'fontname','Arial','fontsize',12);
export_fig 'C:\Users\Anthony Azevedo\Dropbox\Gordon2014\Matlab\CurrentSteps.pdf'
